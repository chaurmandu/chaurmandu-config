...
FROM
    ...
    WHERE
        icd10_code IN ('A30.9' , 'G03', 'B20.9', 'N34.3','N89.8', 'N49.2',  'R10.2','P39.1','N76.6','N50.9', 'A55', 'N76.6', 'NN48.9','A53.9','J22','J06.9','J15.9','J12.9','J40','N39.0','J11.8','N99.9','N49.9')) first_answers
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
  ...
  JOIN diagnosis_concept_view dcv ON dcv.concept_id = o.value_coded
        AND dcv.icd10_code IN ('A30.9' , 'G03', 'B20.9', 'N34.3','N89.8', 'N49.2',  'R10.2','P39.1','N76.6','N50.9', 'A55', 'N76.6', 'NN48.9','A53.9','J22','J06.9','J15.9','J12.9','J40','N39.0','J11.8','N99.9','N49.9')
    WHERE
...
ORDER BY FIELD(first_answers.icd10_code,'A30.9' , 'G03', 'B20.9', 'N34.3','N89.8', 'N49.2',  'R10.2','P39.1','N76.6','N50.9', 'A55', 'N76.6', 'NN48.9','A53.9','J22','J06.9','J15.9','J12.9','J40','N39.0','J11.8','N99.9','N49.9')
