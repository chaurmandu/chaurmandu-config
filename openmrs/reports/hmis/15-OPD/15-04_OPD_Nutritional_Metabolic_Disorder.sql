...
FROM
    ...
    WHERE
        icd10_code IN ('E04.9' , 'E14', 'E46','E61', 'E66.9', 'D64.9', 'G62')) first_answers
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
   ...
   JOIN diagnosis_concept_view dcv ON dcv.concept_id = o.value_coded
        AND dcv.icd10_code IN ('E04.9' , 'E14', 'E46','E61', 'E66.9', 'D64.9', 'G62')
    WHERE
...
ORDER BY FIELD(first_answers.icd10_code,'E04.9' , 'E14', 'E46','E61', 'E66.9', 'D64.9', 'G62')
